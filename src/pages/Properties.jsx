        ...
        return (
            ...
            >
                ...
                <div className="property-list-actions">
                    ...
                    <button className="btn btn-primary btn-sm" onClick={handleContact}>
...
const Properties = () => {
    ...
    const filteredProperties = properties.filter(property => {
        ...
        const matchesZone = filters.zone === 'all' || property.zone === filters.zone;

        return matchesSearch && matchesType && matchesStatus && matchesMeuble && matchesPieces && matchesZone;
    });
    ...
    const resetFilters = () => {
        setFilters({ type: 'all', status: 'all', meuble: 'all', pieces: 'all', zone: 'all' });
        setSearchTerm('');
    };
            ...
            <div className="properties-toolbar">
                <div className="search-filter-group">
                    <div className="search-input">
                        ...
                        <input
                            type="text"
                            placeholder="Rechercher par zone, type, publieur..."
                            value={searchTerm}
